...
export default function BagBrandPageClient() {
  ...
  const isValidBrand = BAG_BRANDS.includes(brandName as any)
  ...
  useEffect(() => {
    ...
    fetchBagBrandListings()
  }, [brandName, isValidBrand, router])

  const getRandomPlaceholder = () => {
    return 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300&h=200&fit=crop&crop=center'
  }
      ...
      <div className="section">
        <div className="container">
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#666', fontSize: '16px' }}>Se încarcă gențile {brandName}...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="container">
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Descoperă colecția de genți {brandName} disponibile pe LuxBid
          </p>
          <div style={{ 
            marginTop: '24px',
            fontSize: '16px',
        ...
        {listings.length === 0 ? (
          <div style={{ 
            ...
            <h3 style={{ 
              ...
              Momentan nu sunt genți {brandName}
            </h3>
            <p style={{ 
              color: '#666', 
              fontSize: '16px', 
              ...
              Fii primul care publică o geantă {brandName} pe LuxBid și ajută-i pe pasionații de modă să o găsească!
            </p>
