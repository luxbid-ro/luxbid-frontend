...
export default function JewelryBrandPageClient() {
  ...
  const isValidBrand = JEWELRY_BRANDS.includes(brandName as any)
  ...
  useEffect(() => {
    ...
    fetchJewelryBrandListings()
  }, [brandName, isValidBrand, router])

  const getRandomPlaceholder = () => {
    return 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=300&h=200&fit=crop&crop=center'
  }
      ...
      <div className="section">
        <div className="container">
          <div style={{ textAlign: 'center', padding: '60px 20px' }}>
            ...
            <p style={{ color: '#666', fontSize: '16px' }}>Se încarcă bijuteriile {brandName}...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="container">
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Descoperă colecția de bijuterii {brandName} disponibile pe LuxBid
          </p>
          <div style={{ 
            marginTop: '24px',
            fontSize: '16px',
        ...
        {listings.length === 0 ? (
          <div style={{ 
            ...
            <h3 style={{ 
              ...
              Momentan nu sunt bijuterii {brandName}
            </h3>
            <p style={{ 
              color: '#666', 
              fontSize: '16px', 
              ...
              Fii primul care publică o bijuterie {brandName} pe LuxBid și ajută-i pe colecționari să o găsească!
            </p>
